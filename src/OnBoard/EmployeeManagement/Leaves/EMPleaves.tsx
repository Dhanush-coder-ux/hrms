    ...
    >
      <header className="mb-8 flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500 mt-1">Track and manage employee leave balances and history.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <StatCard label="Total Employees" value={data.length} icon={Users} iconBg="#f8fafc" iconColor="#0ea5e9" valueSize="2xl" />
        <StatCard label="Active" value={data.length} icon={UserCheck} iconBg="#f0fdf4" iconColor="#22c55e" valueSize="2xl" />
        <StatCard label="Inactive" value="0" icon={UserMinus} iconBg="#fff1f2" iconColor="#f43f5e" valueSize="2xl" />
        <StatCard label="Departments" value="5" icon={Building} iconBg="#eff6ff" iconColor="#1e40af" valueSize="2xl" />
      </div>
