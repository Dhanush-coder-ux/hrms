export const pageTheme = {
  ...
  section: {
    card: "bg-[hsl(var(--card-hsl))] rounded-[20px] overflow-hidden shadow-sm shadow-slate-100 mb-10",
    cardBgColor: "bg-[hsl(var(--card-hsl))]",
    header: "flex items-center justify-between p-[18px_24px] bg-slate-50/30",
  ...
  table: {
    wrapper: "w-full max-h-[520px] overflow-y-auto overflow-x-auto custom-scrollbar border-b border-slate-100",
